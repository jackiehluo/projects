...
[**Mortgage Calculator**](https://github.com/jackiehluo/projects/blob/master/numbers/mortgage-calculator.py) - Calculate the monthly payments of a fixed term mortgage over given Nth terms at a given interest rate. Also figure out how long it will take the user to pay back the loan. For added complexity, add an option for users to select the compounding interval (Monthly, Weekly, Daily, Continually).

[**Change Return Program**](https://github.com/jackiehluo/projects/blob/master/numbers/change-return-program.py) - The user enters a cost and then the amount of money given. The program will figure out the change and the number of quarters, dimes, nickels, pennies needed for the change.
...
[**Unit Converter (temp, currency, volume, mass and more)**](https://github.com/jackiehluo/projects/blob/master/numbers/unit-converter.py) - Converts various units between one another. The user enters the type of unit being entered, the type of unit they want to convert to and then the value. The program will then make the conversion.

[**Alarm Clock**](https://github.com/jackiehluo/projects/blob/master/numbers/alarm-clock/alarm-clock.py) - A simple clock where it plays a sound after X number of minutes/seconds or at a particular time.

[**Distance Between Two Cities**](https://github.com/jackiehluo/projects/blob/master/numbers/distance-between-two-cities.py) - Calculates the distance between two cities and allows the user to specify a unit of distance. This program may require finding coordinates for the cities like latitude and longitude.

[**Credit Card Validator**](https://github.com/jackiehluo/projects/blob/master/numbers/credit-card-validator.py) - Takes in a credit card number from a common credit card vendor (Visa, MasterCard, American Express, Discoverer) and validates it to make sure that it is a valid number (look into how credit cards use a checksum).

[**Tax Calculator**](https://github.com/jackiehluo/projects/blob/master/numbers/tax-calculator.py) - Asks the user to enter a cost and either a country or state tax. It then returns the tax plus the total cost with tax.

[**Factorial Finder**](https://github.com/jackiehluo/projects/blob/master/numbers/factorial-finder.py) - The Factorial of a positive integer, n, is defined as the product of the sequence n, n-1, n-2, ...1 and the factorial of zero, 0, is defined as being 1. Solve this using both loops and recursion.

**Complex Number Algebra** - Show addition, multiplication, negation, and inversion of complex numbers in separate functions. (Subtraction and division operations can be made with pairs of these operations.) Print the results for each operation tested.

[**Happy Numbers**](https://github.com/jackiehluo/projects/blob/master/numbers/happy-numbers.py) - A happy number is defined by the following process. Starting with any positive integer, replace the number by the sum of the squares of its digits, and repeat the process until the number equals 1 (where it will stay), or it loops endlessly in a cycle which does not include 1. Those numbers for which this process ends in 1 are happy numbers, while those that do not end in 1 are unhappy numbers. Display an example of your output here. Find first 8 happy numbers.

**Number Names** - Show how to spell out a number in English. You can use a preexisting implementation or roll your own, but you should support inputs up to at least one million (or the maximum value of your language's default bounded integer type, if that's less). *Optional: Support for inputs other than positive integers (like zero, negative integers, and floating-point numbers).*

[**Coin Flip Simulation**](https://github.com/jackiehluo/projects/blob/master/numbers/coin-flip-simulation.py) - Write some code that simulates flipping a single coin however many times the user decides. The code should record the outcomes and count the number of tails and heads.
...
[**Collatz Conjecture**](https://github.com/jackiehluo/projects/blob/master/classic-algorithms/collatz-conjecture.py) - Start with a number *n > 1*. Find the number of steps it takes to reach one using the following process: If *n* is even, divide it by 2. If *n* is odd, multiply it by 3 and add 1.

[**Sorting**](https://github.com/jackiehluo/projects/blob/master/classic-algorithms/sorting.py) - Implement two types of sorting algorithms: Merge sort and bubble sort.
...
[**Reverse a String**](https://github.com/jackiehluo/projects/blob/master/text/reverse-string.py) - Enter a string and the program will reverse it and print it out.

[**Pig Latin**](https://github.com/jackiehluo/projects/blob/master/text/pig-latin.py) - Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

[**Count Vowels**](https://github.com/jackiehluo/projects/blob/master/text/count-vowels.py) - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](https://github.com/jackiehluo/projects/blob/master/text/check-palindrome.py) - Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

[**Count Words in a String**](https://github.com/jackiehluo/projects/blob/master/text/count-words.py) - Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.
